...
See notes.txt for more information about model selection and other information.
...
Installation
--------------------------------------------------------
1. To setup the environment and start running the project run:
	> vagrant up
	> vagrant ssh
...
Quick Start
--------------------------------------------------------
1. In the browser navigate to Analysis.ipynb. This file will give some intuition behind model selection and procedure.
